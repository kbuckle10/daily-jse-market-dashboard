(() => {
  ...
  function styles(){if(document.getElementById('dividendDateUiStyles'))return;const s=document.createElement('style');s.id='dividendDateUiStyles';s.textContent=`
    ...
    @media(max-width:520px){.div-date{font-size:.64rem}.stock-card .dividend-ex-date-row strong.div-date-value,.stock-card .dividend-pay-date-row strong.div-date-value{justify-content:flex-end;font-size:inherit}}
